                  ...
                  <div class="card form mt-2">
                  	<div class="table card mt-4">
                        <div class="card-body p-0">
                                    ...
                                    <a href="{{route('forwarder-account-export')}}" class="download">
                                    Download Excel
                                    </a>
                                 </div>
									  	</div>
                              ...
                              <table class="table-bordered">
                                 <thead>
                                    <tr>
                                       ...
                                       <th scope="col">GST, PAN, CIN</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                 	@forelse($forwardMaster as $key => $value)
                                 	<tr>
                                 		<td>{{++$key}}</td>
                                 		<td>{{$value->code}}</td>
                                 		<td>{{$value->name}}</td>
                                 		<td>{{$value->website}}</td>
                                        <td>{{$value->gst_no}}, {{$value->pan_no}}, {{$value->cin_no}}</td>
                                 	</tr>
                                 	@empty
                                 	<tr>
                        ...
                        <div class="card-footer text-right">
                           <div class="row">
                              <div class="col-md-10">
                                 {{ $forwardMaster->links('includes.pagination') }}
                              </div>
                              <div class="col-md-2">
