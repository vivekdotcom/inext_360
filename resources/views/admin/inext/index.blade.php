        ...
        <div class="col-md-12">
            <div class="card-body">
                ...
                <div class="tab-content mt-5">
                    <!-- <div class="tab-pane fade show active" id="inext" role="tabpanel"
                        aria-labelledby="inext-tab">
                    </div> -->
                    <!-- <h5 class="card-title text-center">Inext</h5> -->
                    <div class="detail_edit">
                        <fieldset class="form-group border p-3">
                            <legend class="w-auto px-2 text-dark">Inext</legend>
                            <form>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="bind_input">
                                                                    <span class="spacing">:</span>
                                                                    <input type="text" class="form-control"> &nbsp;
                                                                    <button class="btn btn-primary rounded-0">F6</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="bind_input">
                                                                        <span class="spacing">:</span>
                                                                        <input type="text" class="form-control"> &nbsp;
                                                                        <button class="btn btn-primary rounded-0">F7</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <h1 class="inextheading">InExt</h1>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group border p-3 mt-4">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <input type="radio" checked> &nbsp; GENERAL
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <input type="radio"> &nbsp; SILVER
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <input type="radio"> &nbsp; VALUABLE
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <input type="radio"> &nbsp; GTI
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <input type="radio"> &nbsp; IMPORT
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <input type="radio"> &nbsp; DOMESTIC
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <div class="row form-group">
                                                        ...
                                                        <div class="text-center">
                                                            <button class="btn btn-primary rounded-0">Special Handling</button>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-3">
                                                        ...
                                                        <div class="text-center">
                                                            <button class="btn btn-dark rounded-0">Multiple Shipment</button>
                                                        </div>
                                                        <fieldset class="form-group border p-3 mt-5">
                                                        ...
                                                        <fieldset class="form-group border p-3 mt-5">
                                                            ...
                                                            <div class="text-center">
                                                                <button class="btn btn-info rounded-0">Commercial Invoice
                                                                    Details</button>
                                                            </div><br>
                                                            <div class="row form-group">
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="btn_group text-center button_media">
                                                            ...
                                                            <button class="btn btn-secondary rounded-0">Label</button>
                                                            <button class="btn btn-success rounded-0">Print</button>
                                                            <button class="btn btn-warning rounded-0">Void</button>
                                            ...
                                            <div class="col-md-3">
                                                <textarea rows="115"  class=" text inexttextarea"></textarea>
                                                <span class="inextline1">Total Awbno: 0</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
