                  ...
                  <div class="card form mt-2">
                  	<div class="table card mt-4">
                        <div class="card-body p-0">
                                    ...
                                    <a href="{{route('state-export')}}" class="download">
                                    Download Excel
                                    </a>
                                 </div>
									  	</div>
                              ...
                              <table class="table-bordered">
                                 <thead>
                                    <tr>
                                       ...
                                       <th scope="col">GST State Code</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                        ...
                        <div class="card-footer text-right">
                           <div class="row">
                              <div class="col-md-10">
                                 {{ $state->links('includes.pagination') }}
                              </div>
                              <div class="col-md-2">
                                 <a href="{{url('state-index')}}" class="btn btn-secondary save-btn mr-3"> Back
