         ...
         <div class="mt-5">
            ...
            <div class="detail_edit">
               <fieldset class="form-group border p-3">
                  <legend class="w-auto px-2 text-dark">Event_Master</legend>
                  <div class="card form mt-2">
                  	<div class="table card mt-4">
                        <div class="card-body p-0">
                                    ...
                                    <a href="{{route('shipmentevent-export')}}" class="download">
                                    Download Excel
                                    </a>
                                 </div>
									  	</div>
                        ...
                        <div class="card-footer text-right">
                           <div class="row">
                              <div class="col-md-10">
                                 {{ $shipment->links('includes.pagination') }}
                              </div>
                              <div class="col-md-2">
                                 <a href="{{url('shipmentevent-index')}}" class="btn btn-secondary save-btn mr-3"> Back
