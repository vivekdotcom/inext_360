                    ...
                    <!-- <h5 class="card-title">Fuel Setting Master (Export)</h5> -->
                        <div class="detail_edit">
                            <fieldset class="form-group border p-3">
                                ...
                                <form class="" action="{{route('fuel-setting-import-add')}}" method="post">
                                    @csrf
                                <div class="form card mt-2">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="bind_input">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Search Network Code here..." name="search" id="search">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="bind_input">
                                                            ...
                                                            <div class="row form-row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" name="client_name" id="client_name" onkeyup ="deleteData()" placeholder="Search Client.." value="{{old('client_name')}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row name form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="bind_input">
                                                            <span class="spacing">:</span>
                                                            <input type="text" class="form-control" name="network" id="network" value="{{old('network')}}" placeholder="Search Network.."> &nbsp;&nbsp;
                                                ...
                                                <div class="row name form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="bind_input">
                                                            <span class="spacing">:</span>
                                                            <input type="text" class="form-control" name="amount" id="amount" value="{{old('amount')}}" placeholder="0.0">
                                                            &nbsp;&nbsp;
                                                            <span>(%)</span> &nbsp;
                                    ...
                                    <div class="card-footer">
                                        <div class="btn_group text-center button_media">
                                            ...
                                            <a href="{{route('fuel-setting-import-list')}}" class="btn btn-success rounded-0"> List
                                            <i class="fa fa-eye"></i>
                                            </a>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      $('#search_btn').click(function(){
         ...
         $.ajax({
            url: "{{route('fuel-setting-import-index')}}", 
      ...
      $('#delete_fuel').click(function() 
      {
        var id = $('#id').val();
         var token = "{{csrf_token()}}";
         $.ajax({
            url: "{{route('fuel-setting-import-delete')}}", 
            data: {'_token':token,'id':id},
            success: function(){
                alert('Fuel Import Deleted Successfully!')
                location.reload();
            }
      })
   });
