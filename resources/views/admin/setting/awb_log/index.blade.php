                ...
                <div class="tab-content mt-5">
                    ...
                    <div class="detail_edit">
                        <fieldset class="form-group border p-3">
                            <legend class="w-auto px-2 text-dark">Awb Log</legend>
                            <form class="">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mt-3">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="awb-check mb-2">
                                                                <div class="awb">
                                                                    <input type="radio" checked> &nbsp; Awbno
                                                                    &nbsp;&nbsp;
                                                                </div>
                                                                <div class="awb">
                                                                    <input type="radio"> &nbsp; UserWise
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row form-group">
                                                        <div class="col-md-4">
                                                            <label for="name" class="form-label">Enter AwbNo</label>
                                                        </div>
                                                        <div class="col-md-8">
