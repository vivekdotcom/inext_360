         ...
         <div class="mt-5">
            ...
            <div class="detail_edit">
               <fieldset class="form-group border p-3">
                  <legend class="w-auto px-2 text-dark">Customer Details</legend>
                  <div class="card form mt-2">
                  	<div class="table card mt-4">
                        <div class="card-body p-0">
                                    ...
                                    <a href="{{route('customer-list-export')}}" class="download">
                                    Download Excel
                                    </a>
                                 </div>
									  	</div>
                           ...
                           <div class="table-responsive">
                              <table class="table-bordered">
                                 ...
                                 <tbody>
                                 	@forelse($customerAccount as $key => $value)
                                 	<tr>
                                 		<td>{{++$key}}</td>
                                 		<td>{{$value->name}}</td>
                                 		<td>{{$value->code}}</td>
                        ...
                        <div class="row">
                              <div class="col-md-10">
                                 {{ $customerAccount->links('includes.pagination') }}
                              </div>
                              <div class="col-md-2">
                                 <a href="{{route('customers.account.index')}}" class="btn btn-secondary save-btn mr-3"> Back
