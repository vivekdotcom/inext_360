    ...
    <div class="col-md-12">
        <div class="card-body">
            ...
            <div class="mt-5">
                ...
                <form method="post" action="{{route('sale.type.master.add')}}">
                        ...
                        <fieldset class="form-group border p-3">
                            ...
                            <div class="form card mt-2">
                                ...
                                <div class="card-footer text-right">
                                	...
                                	<a href="{{route('sale.type.master.list')}}" class="btn btn-secondary save-btn mr-3"> List
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $('#search-code').click(function(){
         ...
         $.ajax({
            url: "{{route('search.sale.type.master')}}",
            method: "POST",
