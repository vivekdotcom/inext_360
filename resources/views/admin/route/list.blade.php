                  ...
                  <div class="card form mt-2">
                  	<div class="table card mt-4">
                        <div class="card-body p-0">
                                    ...
                                    <a href="{{route('route-export')}}" class="download">
                                    Download Excel
                                    </a>
                                 </div>
									  	</div>
                        ...
                        <div class="row">
                              <div class="col-md-10">
                                 {{ $route->links('includes.pagination') }}
                              </div>
                              <div class="col-md-2">
                                 <a href="{{url('city-index')}}" class="btn btn-secondary save-btn mr-3"> Back
